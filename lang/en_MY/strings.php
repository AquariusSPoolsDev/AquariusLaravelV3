...
return [
    ...
    'faq_pool_safe_kids_answer_1' => 'A pool gives kids a place to swim and play. Pools carry a lower risk than bathtubs, but young children need active supervision near water.',
    'faq_pool_safe_kids_answer_2' => 'Tips to keep your pool safe for kids:',
    'faq_pool_safe_kids_answer_tips_1' => 'Install a fence around the pool:',
    'faq_pool_safe_kids_answer_tips_1_detail' => 'Fence the pool with a minimum 1.5m (5ft) barrier fitted with a self-closing, self-latching gate. This stops young children reaching the pool without an adult present.',
    'faq_pool_safe_kids_answer_tips_2' => 'Supervision:',
    'faq_pool_safe_kids_answer_tips_2_detail' => 'Keep children supervised near the pool. Assign one adult to watch. If a child goes missing, check the pool first. A child can drown in minutes with no splashing or noise.',
    'faq_pool_safe_kids_answer_tips_3' => 'Remove items leaning against the fence:',
    'faq_pool_safe_kids_answer_tips_3_detail' => 'Remove anything leaning against the fence. Children use chairs, toys, and garden equipment as climbing aids.',
    'faq_pool_safe_kids_answer_tips_4' => 'Provide life jackets:',
    'faq_pool_safe_kids_answer_tips_4_detail' => 'Children under 3 should wear a life jacket in the pool. Any child who cannot swim should wear one, unless an adult is supporting them in the water.',
    ...
    'faq_pool_safe_kids_answer_tips_6_detail' => 'Pool chemicals are poisonous if swallowed. Store them out of reach of children in a locked cabinet.',
