    ...
    <div class="main-container">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
                ...
                <h2 class="aquarius-homepage-heading" data-animate data-delay="0">{{__('strings.trust_heading')}}</h2>
                <p class="text-neutral-600 mb-8">{{__('strings.trust_body')}}</p>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    {{-- Stat 3: MSPA membership --}}
                    <div class="col-span-2 border border-neutral-200 rounded-xl p-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="overflow-hidden rounded-xl bg-neutral-100 aspect-video">
                    <img src="{{ asset('assets/images/about/showroom-exterior.jpg') }}"
                         alt="Aquarius Swimming Pools showroom exterior in Johor Bahru"
                         class="w-full h-full object-cover"
                         loading="lazy">
                </div>
                {{-- Three smaller: pool displays --}}
                <div class="grid grid-cols-3 gap-2">
                    <div class="overflow-hidden rounded-xl bg-neutral-100 aspect-square">
                        <img src="{{ asset('assets/images/about/showroom-pool-concrete.jpg') }}"
                             alt="Concrete pool display at Aquarius showroom"
                             class="w-full h-full object-cover"
                             loading="lazy">
                    </div>
                    <div class="overflow-hidden rounded-xl bg-neutral-100 aspect-square">
                        <img src="{{ asset('assets/images/about/showroom-pool-fibreglass.jpg') }}"
                             alt="Fibreglass pool display at Aquarius showroom"
                             class="w-full h-full object-cover"
                             loading="lazy">
                    </div>
                    <div class="overflow-hidden rounded-xl bg-neutral-100 aspect-square">
                        <img src="{{ asset('assets/images/about/showroom-pool-vinyl.jpg') }}"
                             alt="Vinyl pool display at Aquarius showroom"
                             class="w-full h-full object-cover"
                             loading="lazy">
                    </div>
                </div>
