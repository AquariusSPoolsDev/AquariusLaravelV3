...
<div class="">
    ...
    <section class="">
        <h2 class="uppercase text-3xl">Finance Charges:</h2>
        <p>
            ...
            periodic rate: 1 - 1/2% of the balance, which is an <strong>ANNUAL PERCENTAGE RATE OF 18%</strong>.
        </p>
    </section>

    <section class="">
        <h2 class="uppercase text-3xl">Collection Costs:</h2>
        <p>
            If amounts are not paid as agreed, we may demand immediate payment of the full balance. If the balance is
            referred to a collection agency or attorney for collection, you agree to pay a fee of <strong>1/3 (33%)</strong>
            of the total balance due plus any court costs.
        </p>
    </section>

    <section class="">
        <h2 class="uppercase text-3xl">Irregular Payment or Delay in Enforcement:</h2>
        <p>
            Acceptance of late payments or partial payments, checks or money orders marked <strong>"payment in
    ...
    <section class="">
        <h2 class="uppercase text-3xl">Changes or Amemdments:</h2>
        <p>
            Changes to this agreement, including payment terms can be made by us as well as amendments this agreement, at
            any time, provided we give you at least <strong>30 days notice</strong> before the beginning of the billing
            period in which the change or amendment becomes effective.
        </p>
    </section>

    <section class="">
        <h2 class="uppercase text-3xl">Cancellation:</h2>
        <p>
    ...
    <section class="">
        <h2 class="uppercase text-3xl">Liability:</h2>
        <p>
