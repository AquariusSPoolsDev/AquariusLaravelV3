...
<section class="mt-16">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="bg-info-bg overflow-hidden w-full aspect-4/3 object-cover border border-neutral-200 rounded-xl">
            <img src="{{ asset('assets/images/fibreglass/fibreglass-pool-1.jpg') }}" alt="Fibreglass pool 1" class="w-full h-auto hover:scale-105 active:scale-105 transition-all">
        </div>
        <div class="bg-info-bg overflow-hidden w-full aspect-4/3 object-cover border border-neutral-200 rounded-xl">
            <img src="{{ asset('assets/images/fibreglass/fibreglass-pool-2.jpg') }}" alt="Fibreglass pool 2" class="w-full h-auto hover:scale-105 active:scale-105 transition-all">
        </div>
    </div>
</section>
